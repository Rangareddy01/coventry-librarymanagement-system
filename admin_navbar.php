...
<body>
    ...
    if(isset($_SESSION['login_admin_username']))
    {
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                   <a href="index.php"><img src="https://www.coventry.ac.uk/globalassets/media/cu-social_square_small.jpg" width="30px" height="30px" alt="Logo" style="border-radius: 50%;"></a> 
                </div>
                <div class="admin-title">
                <a href="index.php"><h3 style="font-size: 16px;">Coventry University Library Management System</h3></a>
                </div>
    ...
    else
    {
        ...
        <div class="container">
            <div class="navbar">
                <div class="logo">
                   <a href="index.php"><img src="https://www.coventry.ac.uk/globalassets/media/cu-social_square_small.jpg" alt="Logo" style="border-radius: 50%;"></a> 
                </div>
                <div class="title">
                <a href="index.php"><h3 style="font-size: 20px;">Coventry University Library Management System</h3></a>
                </div>
                <nav>
                    <ul id="menuitems">
